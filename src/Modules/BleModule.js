...
export default class BleModule {
  ...
  getMacAddressFromIOS(data) {
    let macAddressInAdvertising =
      data.advertising.kCBAdvDataManufacturerMacAddress;
    ...
    macAddressInAdvertising = macAddressInAdvertising
      ...
      .replace(' ', '');
    if (
      macAddressInAdvertising != undefined &&
      macAddressInAdvertising != null &&
      macAddressInAdvertising != ''
    ) {
      macAddressInAdvertising = this.swapEndianWithColon(
        macAddressInAdvertising,
      );
    }
